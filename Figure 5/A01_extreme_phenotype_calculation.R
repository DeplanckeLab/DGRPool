...
save(phenotype_pivot, file = "Extremes/phenotype_pivot.RData")
...
global_extreme_values_per_DGRP <- extreme_dgrp_fraction_thes_summ %>% 
     ...
     write_tsv("Extremes/global_extreme_values_per_DGRP.tsv", col_names = T) # For GWAS

global_extreme_values_per_DGRP %>% 
  filter(sex == "F") %>% 
  write_tsv("Extremes/global_extreme_values_per_DGRP_females.tsv", col_names = T)

global_extreme_values_per_DGRP %>% 
  filter(sex == "M") %>% 
  write_tsv("Extremes/global_extreme_values_per_DGRP_males.tsv", col_names = T)
