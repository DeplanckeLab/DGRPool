...
pF <- ggplot(ToPlotF, 
  ...
  labs(title = "Female", x = "", y = "Fraction of phenotypes in which a line is extreme", fill = "") +
  theme_bw() +
  theme(axis.line.x = element_line(color="black", size = 0.5),
        axis.line.y = element_line(color="black", size = 0.5),
        axis.text.y = element_text(size=10, color="black"),
...
pExtScatt <- ggplot(input_object, 
  ...
  labs(title = "Correlation between males and females", 
       x = "Extreme phenotype fraction (Females)", 
       y = "Extreme phenotype fraction (Males)", 
       fill = "") +
...
pExtLines <- ggplot(ToPlot, aes(x = dgrp,
  ...
  labs(title = "Most extreme and medicore lines", 
       x = "", 
       y = "Adjusted extremeness fraction (1-x if x > 0.5)", 
       fill = "") +
  theme_bw() +
  theme(axis.line.x = element_line(color="black", size = 0.5),
        axis.line.y = element_line(color="black", size = 0.5),
